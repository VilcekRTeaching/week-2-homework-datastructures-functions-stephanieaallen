...
sapply(nyc[, c("CADMIUM", "LEAD", "CHOLESTEROLTOTAL", "GLUCOSESI", "CREATININESI", "CREATININE")], na.rm= TRUE, FUN = median)
#sapply runs on columns so don’t need to specify margin as columns
